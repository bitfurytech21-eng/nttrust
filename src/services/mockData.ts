...
export const INITIAL_ACCOUNTS: BankAccount[] = [
  {
    ...
    iban: 'US89NT021000089882077771975',
  ...
  },
  {
    ...
    swiftBic: 'NTCOUS33NYC',
    name: 'Jolie-Pitt Humanitarian Global Reserve [LOCKED]',
    type: 'savings',
    currency: 'USD',
    balance: 0.00,
  ...
  },
  {
    ...
    swiftBic: 'NTCOFRPPA',
    name: 'Maddox Jolie-Pitt Foundation Multi-Currency (EUR) [LOCKED]',
    type: 'multicurrency',
    currency: 'EUR',
    balance: 0.00,
    availableBalance: 0.00,
  ...
  },
  {
    ...
    routingNumber: '021000089',
    name: 'Angelina Jolie Sovereign Trust & Atelier Jolie Film Fund [LOCKED]',
    type: 'investment',
    currency: 'USD',
    balance: 0.00,
    availableBalance: 0.00,
  ...
  },
  {
    ...
    routingNumber: '021000089',
    name: '24-Month Sovereign Fixed CD [LOCKED]',
    type: 'cd',
    currency: 'USD',
    balance: 0.00,
    availableBalance: 0.00,
